...
router.get("/", (req, res) => {
	res.json(process.env.SAMPLE_DATA ? JSON.parse(process.env.SAMPLE_DATA) : "Analysis of mutual funds on Zerodha Coin app...");
});

router.get("/test", (req, res) => {
	res.json(process.env.SAMPLE_DATA ? MF_Utils.get_GSHEET_DATA() : "Testing endpoint for the analysis of mutual funds on Zerodha Coin app...");
});
